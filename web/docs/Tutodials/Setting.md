...
The settings section of the software is quite diverse and will be continuously updated with more personalization options as features expand.
...
- **Auto-close Duration**: The duration for which message notification pop-ups automatically close during software operation. Please note that error and warning messages need to be closed manually.
...
## Plotting Module Settings

The plotting module settings specifically address functions within the plotting module, including but not limited to:

* Third-party program path configuration
* Default third-party programs
